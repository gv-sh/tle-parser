...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('fs/promises'), require('fs'), require('path'), require('os'), require('util'), require('stream'), require('zlib')) :
    typeof define === 'function' && define.amd ? define(['exports', 'fs/promises', 'fs', 'path', 'os', 'util', 'stream', 'zlib'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.TLEParser = {}, global.promises, global.fs, global.path, global.os, global.util, global.stream, global.zlib));
})(this, (function (exports, promises, fs, path, os, util, stream, zlib) { 'use strict';
    ...
    class TLEStateMachineParser {
         ...
         */
        constructor(options = {}) {
            this.options = Object.assign({ attemptRecovery: true, maxRecoveryAttempts: 10, includePartialResults: true, strictMode: false }, options);
        ...
        addIssue(severity, code, message, details = {}) {
            const issue = Object.assign({ severity,
                code,
                message, state: this.state }, details);
        ...
        recordRecovery(action, description, context = {}) {
            this.recoveryActions.push(Object.assign({ action,
                description, state: this.state, timestamp: Date.now() }, context));
        ...
        detectFormat(tleString) {
            ...
            if (lines.length > 3) {
                ...
                if (lines.length === 3) {
                    ...
                    const firstChar = (_a = lines[0]) === null || _a === void 0 ? void 0 : _a[0];
        ...
        getResult() {
            ...
            const errors = this.errors.map(e => (Object.assign({ code: e.code, message: e.message, severity: (e.severity === exports.ErrorSeverity.CRITICAL ? 'error' : e.severity) }, Object.fromEntries(Object.entries(e).filter(([key]) => !['severity', 'code', 'message', 'state'].includes(key))))));
            const warnings = this.warnings.map(w => (Object.assign({ code: w.code, message: w.message, severity: 'warning' }, Object.fromEntries(Object.entries(w).filter(([key]) => !['severity', 'code', 'message', 'state'].includes(key))))));
            return {
    ...
    ***************************************************************************** */
    ...
    function parseBatch(input, options = {}) {
        const { filter, continueOnError = false, limit, skip = 0, onTLE, onError } = options, parseOptions = __rest(options, ["filter", "continueOnError", "limit", "skip", "onTLE", "onError"]);
        const results = [];
     ...
     */
    function parseTLEAsync(tleString_1) {
        return __awaiter(this, arguments, void 0, function* (tleString, options = {}) {
     ...
     */
    function parseBatchAsync(input_1) {
     ...
     */
    function validateTLEAsync(tleString_1) {
        return __awaiter(this, arguments, void 0, function* (tleString, options = {}) {
    ...
    class TLEParserStream extends stream.Transform {
        ...
        processTLE(rawTLE) {
            const _a = this.options, { continueOnError = true, filter, onTLE, onError } = _a, parseOptions = __rest(_a, ["continueOnError", "filter", "onTLE", "onError"]);
            try {
                const parsed = parseTLE(rawTLE, parseOptions);
                // Apply filters
                if (filter && !applyFilter(parsed, filter)) {
     ...
     * @returns Promise resolving to array of parsed TLEs
     */
    function parseFromFile(filePath_1) {
        return __awaiter(this, arguments, void 0, function* (filePath, options = {}) {
            const { encoding = 'utf8' } = options, batchOptions = __rest(options, ["encoding"]);
            const content = yield readFileAsync(filePath, { encoding });
     ...
     * @returns Promise resolving to array of parsed TLEs
     */
    function parseFromURL(url_1) {
        return __awaiter(this, arguments, void 0, function* (url, options = {}) {
            const { headers, timeout = 30000 } = options, batchOptions = __rest(options, ["headers", "timeout"]);
     ...
     * @returns Promise resolving to array of parsed TLEs
     */
    function parseFromStream(stream_1) {
        return __awaiter(this, arguments, void 0, function* (stream, options = {}) {
            return new Promise((resolve, reject) => {
                const results = [];
                const parser = createTLEParserStream(Object.assign(Object.assign({}, options), { onTLE: (tle, index) => {
                        results.push(tle);
                        if (options.onTLE) {
     ...
     * @returns Promise resolving to array of parsed TLEs
     */
    function parseFromCompressed(filePath_1) {
        return __awaiter(this, arguments, void 0, function* (filePath, options = {}) {
    ...
    class MiddlewareParser {
         ...
         */
        parse(rawTLE_1) {
            return __awaiter(this, arguments, void 0, function* (rawTLE, options = {}) {
                const context = {
                    rawTLE,
                    options,
                    metadata: {}
                ...
                const execute = (index) => __awaiter(this, void 0, void 0, function* () {
            ...
            return __awaiter(this, arguments, void 0, function* (input, options = {}) {
                ...
                for (const plugin of this.plugins) {
                    if (plugin.onBatchStart) {
                        yield plugin.onBatchStart(options);
                    }
                }
                const results = [];
                const tleSets = splitTLEs(input);
                for (let i = 0; i < tleSets.length; i++) {
                    ...
                    try {
                        ...
                        const parsed = yield this.parse(rawTLE, options);
                        // Apply filters
                        ...
                        for (const plugin of this.plugins) {
                            if (plugin.onTLEParsed) {
                                yield plugin.onTLEParsed(parsed, i);
                            }
                        }
                        if (options.onTLE) {
                ...
                for (const plugin of this.plugins) {
                    if (plugin.onBatchEnd) {
                        yield plugin.onBatchEnd(results);
                    }
                }
                return results;
            });
    ...
    function createCachedParser(cacheOptions = {}) {
        ...
        return {
            ...
            parseAsync: (rawTLE_1, ...args_1) => __awaiter(this, [rawTLE_1, ...args_1], void 0, function* (rawTLE, options = {}) {
                const cached = cache.get(rawTLE, options);
                if (cached)
                    return cached;
                const parsed = yield parseTLEAsync(rawTLE, options);
                cache.set(rawTLE, parsed, options);
                return parsed;
            }),
            cache
     ...
     * @returns Promise resolving to array of parsed TLEs
     */
    function parseParallel(input_1) {
        return __awaiter(this, arguments, void 0, function* (input, options = {}, _workerCount) {
    ...
    function validateAllOrbitalParameters(tle, checkTypical = false) {
        ...
        for (const [key, mapping] of Object.entries(parameterMap)) {
            ...
            if (!result.valid || result.message) {
                results.push(Object.assign(Object.assign({}, result), { context: Object.assign(Object.assign({}, result.context), { field: key }) }));
            }
        }
        return results;
    }
    ...
    const DEFAULT_VALIDATION_RULES = [
        ...
        },
        {
            ...
            validate: (tle, context) => {
                const year = parseInt(tle.epochYear, 10);
                const day = parseFloat(tle.epoch);
                return validateEpochAge(year, day, { referenceDate: context === null || context === void 0 ? void 0 : context.referenceDate });
            }
        },
        {
    ...
    function generateValidationReport(tle, tleLines, options = {}) {
            ...
            for (const result of results) {
                if (!result.valid) {
                    errors.push({
                        ...
                        severity: 'error',
                        field: (_a = result.context) === null || _a === void 0 ? void 0 : _a.field
                    });
                    failedChecks++;
                    ...
                    warnings.push({
                        ...
                        severity: 'warning',
                        field: (_b = result.context) === null || _b === void 0 ? void 0 : _b.field
                    });
                    passedChecks++;
        ...
        if (options.calculateQuality !== false) {
            ...
            qualityScore = calculateQualityScore(tle, {
                ...
                formatValid: errors.filter(e => { var _a; return (_a = e.code) === null || _a === void 0 ? void 0 : _a.includes('FORMAT'); }).length === 0,
    ...
    function formatAsCSV(tle, options = {}) {
        ...
        for (const tleObj of tles) {
            const values = fields.map(field => {
                var _a;
                const value = (_a = tleObj[field]) !== null && _a !== void 0 ? _a : '';
        ...
        for (const tleObj of tles) {
            ...
            for (const [key, value] of Object.entries(tleObj)) {
                ...
                if (Array.isArray(value)) {
                    ...
                    const escapedValue = escapeXML(String(value !== null && value !== void 0 ? value : ''));
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    if (!fs.existsSync(this.cacheDir)) {
                        yield promises.mkdir(this.cacheDir, { recursive: true });
                    }
                    const data = {
                    ...
                    yield promises.writeFile(cachePath, JSON.stringify(data, null, 2), 'utf8');
                }
                catch (error) {
                    // Ignore persistence errors
        ...
        loadFromDisk() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    const content = yield promises.readFile(cachePath, 'utf8');
    ...
    class CelesTrakSource {
        constructor(config = {}) {
            ...
            this.config = Object.assign({ type: 'celestrak', baseUrl: config.baseUrl || this.baseUrl, enableCache: config.enableCache !== false, cacheTTL: config.cacheTTL || 3600000, timeout: config.timeout || 30000, rateLimit: config.rateLimit || {
                    maxRequests: 20,
        ...
        fetch() {
            return __awaiter(this, arguments, void 0, function* (options = {}) {
                ...
                const content = yield this.rateLimiter.execute(() => __awaiter(this, void 0, void 0, function* () {
                    const controller = new AbortController();
    ...
    class SpaceTrackSource {
        constructor(config = {}) {
            ...
            if (!((_a = config.credentials) === null || _a === void 0 ? void 0 : _a.username) || !((_b = config.credentials) === null || _b === void 0 ? void 0 : _b.password)) {
                throw new Error('Space-Track.org requires username and password credentials');
            }
            this.config = Object.assign({ type: 'spacetrack', baseUrl: config.baseUrl || this.baseUrl, credentials: config.credentials, enableCache: config.enableCache !== false, cacheTTL: config.cacheTTL || 1800000, timeout: config.timeout || 60000, rateLimit: config.rateLimit || {
                    maxRequests: 20,
                    intervalMs: 60000 // 20 requests per minute
                } }, config);
            this.rateLimiter = new RateLimiter(this.config.rateLimit);
        ...
        authenticate() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const response = yield fetch(this.authUrl, {
                    method: 'POST',
                    headers: {
        ...
        fetch() {
            return __awaiter(this, arguments, void 0, function* (options = {}) {
                ...
                const content = yield this.rateLimiter.execute(() => __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        const response = yield fetch(url, {
                            headers: Object.assign({ Cookie: `chocolatechip=${this.sessionCookie}` }, this.config.headers),
                            signal: controller.signal
                        });
                        if (!response.ok) {
                            ...
                            if (response.status === 401) {
                                this.sessionCookie = null;
                                yield this.authenticate();
                                const retryResponse = yield fetch(url, {
                                    headers: Object.assign({ Cookie: `chocolatechip=${this.sessionCookie}` }, this.config.headers),
                                    signal: controller.signal
                                });
                                if (!retryResponse.ok) {
                                ...
                                return yield retryResponse.text();
                            }
    ...
    class AMSATSource {
        constructor(config = {}) {
            ...
            this.config = Object.assign({ type: 'amsat', baseUrl: config.baseUrl || this.baseUrl, enableCache: config.enableCache !== false, cacheTTL: config.cacheTTL || 3600000, timeout: config.timeout || 30000, rateLimit: config.rateLimit || {
                    maxRequests: 10,
    ...
    class CustomSource {
        constructor(config) {
            ...
            this.config = Object.assign(Object.assign({}, config), { type: 'custom', enableCache: config.enableCache !== false, cacheTTL: config.cacheTTL || 3600000, timeout: config.timeout || 30000, rateLimit: config.rateLimit || {
                    maxRequests: 10,
                    intervalMs: 60000
                } });
            this.rateLimiter = new RateLimiter(this.config.rateLimit);
        ...
        fetch() {
            return __awaiter(this, arguments, void 0, function* (options = {}) {
                var _a;
                const url = ((_a = options.queryParams) === null || _a === void 0 ? void 0 : _a.url) || this.config.baseUrl;
                ...
                const content = yield this.rateLimiter.execute(() => __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        ...
                        if ((_a = this.config.credentials) === null || _a === void 0 ? void 0 : _a.apiKey) {
    ...
    class DataSourceManager {
         ...
         */
        fetch(sourceName_1) {
            return __awaiter(this, arguments, void 0, function* (sourceName, options = {}) {
                ...
                for (const name of sourceOrder) {
                    ...
                    if (!source)
                        continue;
                    try {
                        return yield source.fetch(options);
                    }
                    catch (error) {
                        lastError = error;
                ...
                throw new Error(`All data sources failed. Last error: ${(lastError === null || lastError === void 0 ? void 0 : lastError.message) || 'Unknown error'}`);
            });
        }
        /**
    ...
    class TLEScheduler {
        ...
        executeUpdate() {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    const result = yield this.manager.fetch(this.config.source || null, this.config.fetchOptions || {});
    ...
    function calculateDopplerShift(tle, observerLocation, date, transmitFrequencyHz) {
        ...
        const range = Math.sqrt(Math.pow(rangeVector.x, 2) + Math.pow(rangeVector.y, 2) + Math.pow(rangeVector.z, 2));
    ...
    function calculateEclipses(tle, startTime, endTime) {
        ...
        for (let timeMs = startMs; timeMs <= endMs; timeMs += stepSeconds * 1000) {
            ...
            const satToSunDist = Math.sqrt(Math.pow(satToSun.x, 2) + Math.pow(satToSun.y, 2) + Math.pow(satToSun.z, 2));
            // Project satellite position onto Earth-Sun line
            const satDist = Math.sqrt(Math.pow(state.position.x, 2) + Math.pow(state.position.y, 2) + Math.pow(state.position.z, 2));
            ...
            let depth = 0;
            if (isInShadow) {
                const perpDist = Math.sqrt(Math.pow(satDist, 2) - Math.pow((dotProduct / satToSunDist), 2));
    ...
    function calculateGroundTrack(tle, startTime, endTime, stepSeconds = 60) {
        ...
        for (let timeMs = startMs; timeMs <= endMs; timeMs += stepSeconds * 1000) {
            ...
            const state = getPositionAtTime(tle, date);
            if (state) {
                const velocityMag = Math.sqrt(Math.pow(state.velocity.x, 2) + Math.pow(state.velocity.y, 2) + Math.pow(state.velocity.z, 2));
                points.push({
                    timestamp: date,
    ...
    function generateOrbitVisualization(tle, numPoints = 100) {
        ...
        const groundTrack = states.map((state) => ({
            ...
            location: state.geographicLocation,
            velocity: Math.sqrt(Math.pow(state.velocity.x, 2) + Math.pow(state.velocity.y, 2) + Math.pow(state.velocity.z, 2)),
        }));
    ...
    function calculateOrbitalParameters(tle) {
        try {
            ...
            const semiMajorAxis = Math.pow((MU_EARTH * Math.pow(periodSeconds, 2)) / (4 * Math.pow(Math.PI, 2)), 1 / 3);
    ...
    function predictConjunctions(tle1, tle2, startTime, endTime, minDistance = 10) {
        ...
        for (let timeMs = startMs; timeMs <= endMs; timeMs += stepSeconds * 1000) {
            ...
            const distance = Math.sqrt(Math.pow((state1.position.x - state2.position.x), 2) +
                Math.pow((state1.position.y - state2.position.y), 2) +
                Math.pow((state1.position.z - state2.position.z), 2));
            ...
            if (distance < previousDistance) {
                ...
                if (previousDistance <= minDistance) {
                    ...
                    const relativeVelocity = Math.sqrt(Math.pow((state1.velocity.x - state2.velocity.x), 2) +
                        Math.pow((state1.velocity.y - state2.velocity.y), 2) +
                        Math.pow((state1.velocity.z - state2.velocity.z), 2));
                    // Assess risk level
                    let riskLevel = 'low';
    ...
    function calculateUpdateFrequency(tles) {
        ...
        if (tles.length < 2) {
            return {
                satelliteNumber: ((_a = tles[0]) === null || _a === void 0 ? void 0 : _a.satelliteNumber1) || 'unknown',
    ...
    function detectAnomalies(currentTLE, previousTLE) {
        ...
        if (meanMotionChange && Math.abs(meanMotionChange.absoluteChange || 0) > 0.01) {
            ...
            description = `Possible orbital maneuver detected. Mean motion changed by ${(_a = meanMotionChange.absoluteChange) === null || _a === void 0 ? void 0 : _a.toFixed(6)} rev/day.`;
        ...
        if (inclinationChange && Math.abs(inclinationChange.absoluteChange || 0) > 0.5) {
            ...
            description += ` Significant inclination change: ${(_b = inclinationChange.absoluteChange) === null || _b === void 0 ? void 0 : _b.toFixed(3)}°.`;
    ...
    function validateLineStructure(line, expectedLineNumber) {
        ...
        if (!checksumResult.isValid && checksumResult.error) {
            errors.push(Object.assign(Object.assign({}, checksumResult.error), { line: expectedLineNumber, message: `Line ${expectedLineNumber}: ${checksumResult.error.message}` }));
        }
    ...
    function validateTLE(tleString, options = {}) {
        ...
        if (!line1Result.isValid) {
            ...
            if (mode === 'permissive') {
                ...
                warnings.push(...(checksumErrors.map(e => (Object.assign(Object.assign({}, e), { severity: 'warning' })))));
        ...
        if (!satNumResult.isValid && satNumResult.error) {
            if (mode === 'permissive') {
                ...
                warnings.push(Object.assign(Object.assign({}, satNumResult.error), { severity: 'warning' }));
            }
            else {
        ...
        if (!classResult.isValid && classResult.error) {
            if (mode === 'permissive') {
                ...
                warnings.push(Object.assign(Object.assign({}, classResult.error), { severity: 'warning' }));
            }
            else {
            ...
            for (const { value, name, min, max, optional, warningOnly } of rangeValidations) {
                ...
                if (!result.isValid && result.error) {
                    if (warningOnly || mode === 'permissive') {
                        warnings.push(Object.assign(Object.assign({}, result.error), { severity: 'warning' }));
                    }
                    else {
