 ...
 * @license MIT
 */
import { mkdir, writeFile, readFile as readFile$1 } from 'fs/promises';
import { readFile, createReadStream, existsSync } from 'fs';
...
class TTLCache {
    ...
    async loadFromDisk() {
        ...
        try {
            ...
            const content = await readFile$1(cachePath, 'utf8');
...
export { AMSATSource, CONSTELLATIONS, CelesTrakSource, Colors, CustomSource, DEFAULT_VALIDATION_RULES, DESIGNATOR_CONSTRAINTS, DataSourceManager, EPOCH_CONSTRAINTS, ERROR_CODES, ErrorSeverityEnum as ErrorSeverity, IncrementalParser, MiddlewareParser, ORBITAL_PARAMETER_RANGES, ParserState, QUALITY_SCORE_WEIGHTS, RateLimiter, RateLimiterManager, RecoveryAction, SATELLITE_NUMBER_RANGES, SCHEDULE_INTERVALS, SchedulerManager, SpaceTrackSource, TLECache, TLEErrorCode, TLEFormatError, TLEParserStream, TLEScheduler, TLEStateMachineParser, TLEValidationError, TTLCache, ValidationRuleManager, applyFilter, calculateChecksum, calculateEpochAge, calculateQualityScore, checkClassificationWarnings, checkDragAndEphemerisWarnings, checkEpochWarnings, checkOrbitalParameterWarnings, convertEpochToDate, createCachedParser, createConstellationFilter, createIncrementalParser, createMiddlewareParser, createTLEParserStream, createValidationRule, index as default, detectAnomalies, filterByConstellation, filterByFreshness, formatAsCSV, formatAsHuman, formatAsJSON, formatAsXML, formatAsYAML, formatTLE, generateCacheKey, generateValidationReport, getConstellation, getErrorDescription, getProfileOptions, getProviderOptions, groupByConstellation, isCriticalError, isParseFailure, isParseSuccess, isParsedTLE, isTLEError, isTLEWarning, isValidClassification, isValidErrorCode, isValidationFailure, isValidationSuccess, isWarningCode, listConstellations, matchesConstellation, normalizeAssumedDecimalNotation, normalizeLineEndings, normalizeScientificNotation, parseBatch, parseBatchAsync, parseFromCompressed, parseFromFile, parseFromStream, parseFromURL, parseInterval, parseParallel, parseTLE, parseTLEAsync, parseTLELines, parseWithProfile, parseWithProvider, parseWithStateMachine, reconstructTLE, sanitizeAllFields, sanitizeField, splitTLEs, tleCache, validateAllOrbitalParameters, validateChecksum, validateClassification, validateEpochAge, validateEpochDate, validateFreshness, validateInternationalDesignator, validateLineStructure, validateNumericRange, validateOrbitalParameter, validateSatelliteNumber, validateTLE, validateTLEAsync };
