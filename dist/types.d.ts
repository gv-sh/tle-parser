 ...
 */
export declare enum TLEErrorCode {
 ...
 */
export type Parser<TOptions = TLEParseOptions, TResult = ParsedTLE> = (input: string, options?: TOptions) => TResult;
/**
 * Generic validator function type
 * @template TOptions - The options type for validation
 */
export type Validator<TOptions = TLEValidateOptions> = (input: string, options?: TOptions) => ValidationResult | LegacyValidationResult;
/**
 ...
 */
export type ExtendedParsedTLE<TCustomFields extends Record<string, unknown> = Record<string, never>> = ParsedTLE & TCustomFields;
/**
 ...
 */
export declare function isParseSuccess<T extends ParsedTLE = ParsedTLE>(result: ParseResult<T>): result is ParseSuccess<T>;
/**
 * Type guard to check if a parse result is a failure
 */
export declare function isParseFailure<T extends ParsedTLE = ParsedTLE>(result: ParseResult<T>): result is ParseFailure;
/**
 * Type guard to check if an error is a TLE error
 */
export declare function isTLEError(error: unknown): error is TLEError;
/**
 * Type guard to check if an error is a TLE warning
 */
export declare function isTLEWarning(error: unknown): error is TLEWarning;
/**
 * Type guard to check if a value is a valid classification
 */
export declare function isValidClassification(value: string): value is ClassificationType;
/**
 * Type guard to check if an object is a ParsedTLE
 */
export declare function isParsedTLE(obj: unknown): obj is ParsedTLE;
/**
